...
display_row_right_aligned("Profitto/Perdita Netto Costi", delta_netto_costi, (delta_netto_costi/capitale_versato)*100)
st.divider()
display_row_right_aligned("Tasse", tasse, (tasse/capitale_versato)*100)
